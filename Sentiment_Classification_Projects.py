...
for index, ratio in pos_neg_ratios.most_common():
    pos_neg_ratios[index] = np.log(ratio)
...
(pos_neg_ratios.most_common())[:-20:-1]
...
class SentimentNetwork:
    ...
    def pre_process_data(self, reviews, labels):
        ...
        # add words from the review to a set called review_vocab
        review_vocab = set()
    ...
    def init_network(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # Create the input layer, a two-dimensional matrix with shape 1 x input_nodes
    ...
    def train(self, training_reviews, training_labels):
        ...
        for i in range(len(training_reviews)):
            ...
            ## FORWARD PASS ##
            # Input Layer - input (training review text)
            self.update_input_layer(review)

            # Hidden layer - layer_0 dot weights_0_1
            layer_1 = self.layer_0.dot(self.weights_0_1)

            # Output layer - layer_1 dot weights_1_2 and activate
